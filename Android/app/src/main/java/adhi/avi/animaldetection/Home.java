...
public class
Home extends AppCompatActivity implements  View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onClick(View view) {
        if(view==btn_browse){
            ...
            try{
                ...
                Toast.makeText(Home.this, "There are no file explorer clients installed.", Toast.LENGTH_SHORT).show();
            }
        }
