...
public class Record_animal_sound_copy extends AppCompatActivity implements View.OnClickListener {
    Button b1,b2,b3;
    ...
    public void onClick(View view) {
        if (view==b1)
        {
            if(checkPermission()) {
                ...
                Toast.makeText(Record_animal_sound_copy.this, "Recording started",
        ...
        if (view==b2)
        {
            ...
            Toast.makeText(Record_animal_sound_copy.this, "Recording Completed",
                    Toast.LENGTH_LONG).show();
...
//            finish();
        ...
        {
            if(fileBytes==null){
                Toast.makeText(Record_animal_sound_copy.this, "No file selected! please select any file to continue.", Toast.LENGTH_SHORT).show();
            }
            else {
                uploadFile();
            }
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(Record_animal_sound_copy.this, new
            ...
            case RequestPermissionCode:
                if (grantResults.length> 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        Toast.makeText(Record_animal_sound_copy.this, "Permission Granted",
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(Record_animal_sound_copy.this,"Permission Denied",Toast.LENGTH_LONG).show();
                    }
                }
                break;
        }
    ...
    private void uploadFile() {
        ...
        final ProgressDialog pd=new ProgressDialog(Record_animal_sound_copy.this);
                    ...
                    public void onResponse(NetworkResponse response) {
                        try {
                            ...
                            if(status.equalsIgnoreCase("success")){
                                ...
                                Toast.makeText(Record_animal_sound_copy.this, "not found", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Toast.makeText(Record_animal_sound_copy.this, e.toString(), Toast.LENGTH_SHORT).show();
                            e.printStackTrace();
                        }
                    }
                },
