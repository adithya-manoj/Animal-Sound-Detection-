...
public class Sam_copy extends AppCompatActivity
...
//        });
    ...
    public void onClick(View view) {
        if(view==btn_browse){
            ...
            try{
                ...
                Toast.makeText(Sam_copy.this, "There are no file explorer clients installed.", Toast.LENGTH_SHORT).show();
            }
        }
        else if(view==btn_upload) {

            if(fileBytes==null){
                Toast.makeText(Sam_copy.this, "No file selected! please select any file to continue.", Toast.LENGTH_SHORT).show();
            }
            else {
                uploadFile();
            }
    ...
    private void uploadFile() {
        ...
        final ProgressDialog pd=new ProgressDialog(Sam_copy.this);
                    ...
                    public void onResponse(NetworkResponse response) {
                        try {
                            ...
                            if(status.equalsIgnoreCase("success")){
                                ...
                                Toast.makeText(Sam_copy.this, "not found", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Toast.makeText(Sam_copy.this, e.toString(), Toast.LENGTH_SHORT).show();
                            e.printStackTrace();
                        }
                    }
                },
